...
if(!empty($arResult['SKU_PROPS'])){
    if($arResult['SKU_PROPS']['SIZES']){
        $arResult['SKU_PROPS']['SIZES']['VALUES']['custom_info']['ID'] = "custom_info";
...
<?$this->EndViewTarget();?>
<?
$component->arResult['HTML'] = ob_get_clean();
$component->SetResultCacheKeys(array('HTML'));
?>
