					...
					<table class="bx-added-item-table">
						...
						<?foreach($arResult["SET_ITEMS"]["DEFAULT"] as $key => $arItem):?>
							<tr
								...
								class=""
							>
								<td class="choice_nabor">
									<span class="choice_icon" data-role="set-add-btn"></span>
								</td>
								...
								<td class="bx-added-item-table-cell-itemname">
                                    ...
                                    <span><?=$arItem["BASKET_QUANTITY"];?> <?=$arItem["MEASURE"]["SYMBOL_RUS"];?></span>
								</td>
		...
		<div class="row result">
			<div class="col-sm-12">
				<table class="bx-constructor-result-table">
					...
					<tr>
					<td colspan="4">
							<a href="javascript:void(0)" data-role="set-buy-btn" class="btn btn-default btn-sm custom-btn"
